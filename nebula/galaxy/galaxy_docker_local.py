...
from nebula.warpdrive import RemoteGalaxy, web_wait, library_paste_sync
...
class GalaxyLocalService(Service):
    ...
    def __init__(self, docstore, **kwds):
        super(GalaxyLocalService, self).__init__('galaxy')
        self.config = kwds
    ...
    def to_dict(self):
        return {
            'service_type' : 'GalaxyLocalService',
            'config' : self.config,
    ...
    def from_dict(data):
        ...
        return GalaxyLocalService( doc_store, **data['config'] )
